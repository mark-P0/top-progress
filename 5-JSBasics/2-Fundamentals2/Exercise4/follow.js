...
/* Step 2 (Mine) */
// const firstName = 'Manicio';
// const lastName = 'Sta. Cruz';
// const currentYear = 2021;
// const birthYear = 1998;

// const greeting = `Hello! My name is ${firstName} ${lastName}. I am ${
...
greeting = `Hello! My name is ${firstName} ${lastName}. I am ${
  thisYear - birthYear
} years old.`;
console.log(greeting);
